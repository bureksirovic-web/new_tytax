...
import type { E1RMDataPoint } from '@/lib/analytics/pr-tracker';

interface Props {
  params: Promise<{ exerciseId: string }>;
}

function E1RMChart({ points }: { points: E1RMDataPoint[] }) {
  if (points.length === 0) {
    return (
...
export default function ExerciseAnalyticsPage({ params }: Props) {
  ...
  const best = e1rmProgression.reduce<E1RMDataPoint | null>(
