...
export default function ProgramDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  // Loading state: useLiveQuery returns undefined before first result
  ...
  // Not found (query resolved but program doesn't exist)
  if (program === null) {
    return (
      <EmptyState
        icon="◈"
  ...
  // Narrowed: program is Program from here
